...
export default function Buyers() {
  ...
  const handleExport = (format) => {
    ...
    if (format === 'pdf') exportToPDF({ ...exportData, fileName: `Buyers_${todayISO()}.pdf` });
    else if (format === 'xlsx') exportToXLSX({ ...exportData, fileName: `Buyers_${todayISO()}.xlsx` });
    else if (format === 'csv') exportToCSV({ ...exportData, fileName: `Buyers_${todayISO()}.csv` });
  };
